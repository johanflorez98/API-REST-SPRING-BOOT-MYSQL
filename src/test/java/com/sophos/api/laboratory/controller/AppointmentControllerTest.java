...
class AppointmentControllerTest {
    ...
    void getlist200() {
        ...
        when(appointmentServiceImp.getlist()).thenReturn(appointment);
    ...
    @Test
    void getbyid200() {
        when(appointmentServiceImp.getbyid(anyLong())).thenReturn(Optional.of(new Appointment()));
        assertEquals(HttpStatus.OK, appointmentController.getbyid(anyLong()).getStatusCode());
    }

    @Test
    void getbyid404() {
        when(appointmentServiceImp.getbyid(anyLong())).thenReturn(Optional.empty());
    ...
    void post201() {
        ...
        when(appointmentServiceImp.post(appointment)).thenReturn("Save");
    ...
    void post404() {
        Appointment appointment = new Appointment();
        when(appointmentServiceImp.post(appointment)).thenReturn("No save");
        assertEquals(HttpStatus.NOT_FOUND, appointmentController.post(appointment).getStatusCode());
    }

    @Test
    void delete200() {
        when(appointmentServiceImp.delete(anyLong())).thenReturn("deleted");
        assertEquals(HttpStatus.OK, appointmentController.delete(anyLong()).getStatusCode());
    }

    @Test
    void delete204() {
        when(appointmentServiceImp.delete(anyLong())).thenReturn("no deleted");
    ...
    void put201() {
        Appointment appointment = new Appointment();
        when(appointmentServiceImp.put(appointment)).thenReturn(Optional.of(appointment));
    ...
    void put404() {
        Appointment appointment = new Appointment();
        when(appointmentServiceImp.put(appointment)).thenReturn(Optional.empty());
    ...
    void getbyaffiliate200() {
        List<Appointment> appointment = new ArrayList<Appointment>();
        appointment.add(new Appointment());
        when(appointmentServiceImp.getbyaffiliate(anyLong())).thenReturn(appointment);
    ...
    void getbydate200() {
        List<Appointment> appointment = new ArrayList<Appointment>();
        appointment.add(new Appointment());
        when(appointmentServiceImp.getbydate(anyString())).thenReturn(appointment);
